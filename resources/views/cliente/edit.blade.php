...
<div class="row justify-content-center">
     <div class="col-lg-6">
        <div class="card  ">
        <div class="card-body ">
        <h4 class="card-title">Actualizar datos del Cliente.</h4>
        <form class="table-responsive m-t-40">
                ...
                {!!Form::text('id_cliente',null,['class'=>'form-control', 'readonly' => 'readonly'])!!}
            </div>
            ...
            <div class="form-group row ">
                ...
                {!!Form::text('nombre',null,['class'=>'form-control', 'placeholder'=>'Colocar el Nombre del Cliente.'])!!}
            ...
            <div class="form-group row ">
                ...
                <div class="input-group">
                <div class="input-group-addon"><i class="ti-user"></i></div>
                {!!Form::text('ap_pat',null,['class'=>'form-control', 'placeholder'=>'Colocar el Nombre del Cliente.'])!!}
            ...
            <div class="form-group row ">
                ...
                <div class="input-group">
                <div class="input-group-addon"><i class="ti-user"></i></div>
                {!!Form::text('ap_mat',null,['class'=>'form-control', 'placeholder'=>'Colocar el Nombre del Cliente.'])!!}
